...
/**
 * {@link ReverseCarAccessibilityCheck} test data.
 *
 * @author sayana
 */
public class ReverseCarAccessibilityCheckTestRule extends CoreTestRule
{
    ...
    @TestAtlas(
            ...
            edges = {
                    @TestAtlas.Edge(coordinates = { @TestAtlas.Loc(value = TEST_1),
                            @TestAtlas.Loc(value = TEST_3) }, tags = { "highway=PEDESTRIAN",
                            "access=yes", "vehicle=yes" }),
                    @TestAtlas.Edge(id = "1001000001", coordinates = {
                            @TestAtlas.Loc(value = TEST_3), @TestAtlas.Loc(value = TEST_4),
                            @TestAtlas.Loc(value = TEST_5) }, tags = { "highway=CYCLEWAY",
                    ...
                    @TestAtlas.Edge(id = "1001100001", coordinates = {
                            @TestAtlas.Loc(value = TEST_5),
                            @TestAtlas.Loc(value = TEST_8) }, tags = { "highway=STEPS",
                            "access=yes", "vehicle=no", "motorcar=yes",
                            "motor_vehicle=no" }), })
    ...
    @TestAtlas(
            ...
            edges = { @TestAtlas.Edge(id = "1000000001", coordinates = {
                    ...
                    "highway=ROAD", "access=yes", "vehicle=no" }),
                    @TestAtlas.Edge(id = "1001000001", coordinates = {
                            @TestAtlas.Loc(value = TEST_3),
    ...
    @TestAtlas(
            ...
            edges = { @TestAtlas.Edge(id = "1000000001", coordinates = {
                    ...
                    @TestAtlas.Edge(id = "1001000001", coordinates = {
                            @TestAtlas.Loc(value = TEST_3),
                            @TestAtlas.Loc(value = TEST_4) }, tags = { "highway=STEPS",
